...
public class TelaLogin extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Logo 300x300.png"))); // NOI18N

        jPanel3.setBackground(new java.awt.Color(31, 126, 151));
        ...
        setSize(new java.awt.Dimension(603, 354));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (u != null) {
            ...
            if (u.getPermissao().equalsIgnoreCase("ADMIN")) {
                MenuAdministrador telaAdm = new MenuAdministrador(u);
                telaAdm.setVisible(true);
                this.dispose(); // fecha a tela de login
            } else {
                // Exemplo para médico
                JOptionPane.showMessageDialog(this, "Redirecionar para tela de médico.");
            }
